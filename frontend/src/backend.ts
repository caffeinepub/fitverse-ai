...
export class Backend implements backendInterface {
    ...
    async getFilteredProducts(arg0: string | null, arg1: string | null, arg2: bigint): Promise<Array<Product>> {
        if (this.processError) {
            try {
                const result = await this.actor.getFilteredProducts(to_candid_opt_n1(this._uploadFile, this._downloadFile, arg0), to_candid_opt_n1(this._uploadFile, this._downloadFile, arg1), arg2);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
